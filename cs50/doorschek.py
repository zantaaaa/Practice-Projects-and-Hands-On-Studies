...
#esta función realiza una búsqueda binaria para determinar si una puerta está abierta o cerrada
#una busqueda que binaria es un algoritmo de búsqueda que encuentra la posición de un elemento en una lista ordenada dividiendo repetidamente el rango de búsqueda a la mitad.
